...
export const PacksDoubleSlider = () => {
    ...
    return (
        <Box sx={{height: '62px', width: '300px', display: 'grid'}}>
            ...
            <DoubleSlider minFromServer={min} maxFromServer={max}
                          minFromFilter={filterMin} maxFromFilter={filterMax}
                          setMinMaxCount={setMinMaxPacksCount} disabled={status === 'loading'}
            />
        </Box>
    )
}